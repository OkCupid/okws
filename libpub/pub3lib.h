...
#define PUB3_COMPILED_FN(x, pat)                                               \
  ...
  public:                                                                      \
    ...
    ptr<const expr_t> v_eval_2(eval_t *p,                                      \
                               const vec<arg_t> &args) const override;         \
    PUB3_DOC_MEMBERS                                                           \
  }
...
#define PUB3_FILTER(x)                                                         \
  ...
  public:                                                                      \
    ...
    ptr<const expr_t> v_eval_2(eval_t *e,                                      \
                               const vec<arg_t> &args) const override {        \
...
#define PUB3_COMPILED_UNPATTERNED_FN(x)                                        \
  ...
  public:                                                                      \
    x##_t() : compiled_fn_t(libname, #x) {}                                    \
    ptr<const expr_t> v_eval_1(eval_t *p, const margs_t &args) const;          \
    PUB3_DOC_MEMBERS                                                           \
  }
