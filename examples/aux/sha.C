...
/*
 * Generated by pub from file: /home/am0/max/oksamples/websrv/sha.g
 * DO NOT EDIT!!!
 */


#line 1 "/home/am0/max/oksamples/websrv/sha.g"
// -*-c++-*-
/* $Id$ */
...
#line 37 "/home/am0/max/oksamples/websrv/sha.g"
 }
  dbcon_t *shadb;
};
...
#line 82 "/home/am0/max/oksamples/websrv/sha.g"
  out << "<html>\n <head>\n  <title>SHA1 Dictionary Querier</t"
        "itle>\n </head>\n<body>\n"
    ;

#line 89 "/home/am0/max/oksamples/websrv/sha.g"


    if (s) 
      
#line 93 "/home/am0/max/oksamples/websrv/sha.g"
  out << "<font face=helvetica color=blue size=+1>"
     << s
     << "</font>\n<br><hr>\n"
    ;

#line 97 "/home/am0/max/oksamples/websrv/sha.g"


    
#line 100 "/home/am0/max/oksamples/websrv/sha.g"
  out << "<b>Ask Me For the SHA of your Favorite Word</b>\n<f"
        "orm action=\"/sha\">\nAsk Away: <input type=text name"
        "=x> &nbsp;\n<input type=submit name=submit value=su"
        "bmit>\n<input type=hidden name=z value=1>\n</form>\n<"
        "/body>\n</html>\n"
    ;

#line 110 "/home/am0/max/oksamples/websrv/sha.g"
